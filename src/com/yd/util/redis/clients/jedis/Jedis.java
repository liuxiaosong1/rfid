...
import com.yd.util.redis.clients.util.Pool;
import com.yd.util.redis.clients.util.SafeEncoder;
import com.yd.util.redis.clients.util.Slowlog;
...
public class Jedis extends BinaryJedis implements JedisCommands,
    ...
    public String ds_set(final String key, String value) {
	checkIsInMulti();
    ...
    public String ds_get(final String key) {
	checkIsInMulti();
	client.sendCommand(Protocol.Command.DS_GET, key);
	return client.getBulkReply();
    }
    ...
    public Map<String, String> ds_hgetAll(final String key) {
	checkIsInMulti();
	client.ds_hgetAll(key);
	return BuilderFactory.STRING_MAP
		.build(client.getBinaryMultiBulkReply());
    }
