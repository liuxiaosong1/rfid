...
public class Client extends BinaryClient implements Commands {
    ...
    public void ds_set(final String key, final String value) {
    	ds_set(SafeEncoder.encode(key), SafeEncoder.encode(value));
    }
    ...
    public void ds_hgetAll(final String key) {
	ds_hgetAll(SafeEncoder.encode(key));
    }
...
public void clusterSetSlotStable(final int slot) {
	...
	@Override
	public void ds_hset(String key, String field, String value) {
	ds_hset(SafeEncoder.encode(key), SafeEncoder.encode(field),
		SafeEncoder.encode(value));
	}

	@Override
	public void ds_hget(String key, String field) {
		// TODO Auto-generated method stub
		ds_hget(SafeEncoder.encode(key), SafeEncoder.encode(field));
	}

	@Override
	public void ds_get(String key) {
		ds_get(SafeEncoder.encode(key));
