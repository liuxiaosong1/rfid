...
import com.yd.util.redis.clients.util.Hashing;
...
public class ShardedJedis extends BinaryShardedJedis implements JedisCommands,
    ...
    public Map<String, String> ds_hgetAll(String key) {
	Jedis j = getShard(key);
	return j.ds_hgetAll(key);
    }
	...
	@Override
	public String ds_set(String key, String value) {
		Jedis j = getShard(key);
		return j.ds_set(key, value);
	}
}
