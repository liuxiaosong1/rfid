...
public interface Commands {
    ...
    public void ds_get(final String key);
    ...
    public void ds_hset(final String key, final String field, final String value);
    
    public void ds_hget(final String key, final String field);
