...
import com.yd.util.redis.clients.jedis.Protocol.Command;
import com.yd.util.redis.clients.jedis.Protocol.Keyword;
import static com.yd.util.redis.clients.jedis.Protocol.Command.*;
import static com.yd.util.redis.clients.jedis.Protocol.Command.EXISTS;
import static com.yd.util.redis.clients.jedis.Protocol.Command.PSUBSCRIBE;
import static com.yd.util.redis.clients.jedis.Protocol.Command.PUNSUBSCRIBE;
import static com.yd.util.redis.clients.jedis.Protocol.Command.SUBSCRIBE;
import static com.yd.util.redis.clients.jedis.Protocol.Command.UNSUBSCRIBE;
import static com.yd.util.redis.clients.jedis.Protocol.Keyword.*;
import static com.yd.util.redis.clients.jedis.Protocol.toByteArray;
...
public class BinaryClient extends Connection {
    ...
    public void ds_set(final byte[] key, final byte[] value) {
	sendCommand(Command.DS_SET, key, value);
    }
    ...
    public void ds_get(final byte[] key) {
	sendCommand(Command.DS_GET, key);
    }
    ...
    public void ds_hgetAll(final byte[] key) {
	sendCommand(DS_HGETALL, key);
    }
    ...
    public void ds_hset(byte[] key, byte[] field, byte[] value) {
    	sendCommand(DS_HSET, key, field, value);
    }
    
    public void ds_hget(byte[] key, byte[] field) {
    	sendCommand(DS_HGET, key, field);
    }
}
